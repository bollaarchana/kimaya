    ...
    <>
      <section className="relative items-center overflow-hidden bg-[#F8F6FD] pt-3">
        ...
        <section className="relative overflow-hidden py-24 bg-gradient-to-r from-[#2D1663] via-[#3B1E75] to-[#2D1663]">
          ...
          <div className="absolute -bottom-28 -right-28 w-96 h-96 rounded-full bg-orange-500/10"></div>
          ...
          <Container fluid="xxl">
            <div className="relative z-10 max-w-4xl mx-auto text-center">
              ...
              <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
                <Link
                  to="/contact"
                  className="inline-flex items-center justify-center gap-3 bg-orange-500 text-white px-8 py-4 rounded-xl font-semibold hover:bg-orange-600 transition-all duration-300 hover:shadow-lg"
                >
